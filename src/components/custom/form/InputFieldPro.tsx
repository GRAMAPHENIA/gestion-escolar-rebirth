  ...
  return (
    <div className="mb-6 w-full">
      ...
      <input
        ...
        className="w-full p-3  border-b-2 border-x-0 border-t-0 rounded-md border-orange-400 bg-orange-500/5 shadow-sm focus:ring-opacity-0 focus:border-orange-400/80 focus:outline-none dark:border-orange-400/50 text-base"
        required
      />
